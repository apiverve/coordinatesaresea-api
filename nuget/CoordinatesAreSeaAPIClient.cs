...
namespace APIVerve.API.CoordinatesAreSea
{
    ...
    /// <summary>
    /// Client for the CoordinatesAreSea API
    /// </summary>
    public class CoordinatesAreSeaAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/coordinatesaresea";
        ...
        public CoordinatesAreSeaAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CoordinatesAreSeaAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CoordinatesAreSeaAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CoordinatesAreSeaQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CoordinatesAreSeaQueryOptions options)
        {
        ...
        public ResponseObj Execute(CoordinatesAreSeaQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CoordinatesAreSeaQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CoordinatesAreSeaQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CoordinatesAreSeaQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CoordinatesAreSeaQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CoordinatesAreSeaQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CoordinatesAreSeaQueryOptions options)
        {
