# Coordinates Are Sea Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:coordinatesaresea-api:1.1.12'
}
```
...
```java
import com.apiverve.coordinatesaresea.CoordinatesAreSeaAPIClient;
import com.apiverve.coordinatesaresea.APIResponse;
import com.apiverve.coordinatesaresea.APIException;

// Initialize the client
CoordinatesAreSeaAPIClient client = new CoordinatesAreSeaAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/coordinatesaresea](https://docs.apiverve.com/ref/coordinatesaresea)
...
- **Documentation:** [https://docs.apiverve.com/ref/coordinatesaresea](https://docs.apiverve.com/ref/coordinatesaresea)
- **Issues:** [GitHub Issues](https://github.com/apiverve/coordinatesaresea-api/issues)
