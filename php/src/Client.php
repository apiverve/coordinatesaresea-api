...
namespace APIVerve\Coordinatesaresea;
...
/**
 * Client for the Coordinates Are Sea API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/coordinatesaresea?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/coordinatesaresea';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CoordinatesareseaClient] {$message}\n";
        }
    }
}
